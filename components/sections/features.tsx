...
const features = [
  ...
  },
  {
    ...
    description: "Connect with thousands of learners worldwide and grow together",
    color: "from-purple-500 to-pink-500",
  },
  {
    icon: Award,
    title: "Certifications",
    description: "Earn recognized certificates that boost your professional profile",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Everything you need to succeed in your learning journey with cutting-edge features
          </p>
        </motion.div>
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -15, boxShadow: "0 30px 60px rgba(111, 77, 243, 0.2)" }}
