...
const stats = [
  { label: "Active Students", value: "500K+", icon: "👥", color: "from-blue-500 to-cyan-500" },
  { label: "Expert Instructors", value: "5K+", icon: "👨‍🏫", color: "from-purple-500 to-pink-500" },
  { label: "Courses Available", value: "10K+", icon: "📚", color: "from-orange-500 to-red-500" },
  { label: "Countries Reached", value: "195+", icon: "🌍", color: "from-green-500 to-emerald-500" },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <motion.h3 className="text-4xl font-bold gradient-text mb-2">{counts[index]}K+</motion.h3>
